...
public class CrateConnectorFactory
        implements ConnectorFactory
{
    private final TypeManager typeManager;
    private final Map<String, String> optionalConfig;

    public CrateConnectorFactory(TypeManager typeManager, Map<String, String> optionalConfig)
    {
    ...
    public Connector create(final String connectorId, Map<String, String> requiredConfig)
    {
        ...
        try {
            ...
            Bootstrap app = new Bootstrap(
                    new CrateClientModule(connectorId, typeManager));
        ...
        Injector injector = app
            ...
            return injector.getInstance(CrateConnector.class);
        }
        catch (Exception e) {
